...
def main():
    ...
    fft_group.add_argument('--noise_level', type=float, default=0.08, help='FFT噪声强度')
    fft_group.add_argument('--frequency_ratio', type=float, default=0.5, help='FFT扰动频率范围比例')
    ...
    denoise_group.add_argument('--window_size', type=int, default=5, help='去毛刺滑动窗口大小')
