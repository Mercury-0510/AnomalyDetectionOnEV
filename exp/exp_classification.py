...
class Exp_Classification(Exp_Basic):
    ...
    def _plot_training_curves(self, epochs, train_losses, vali_losses, vali_f1_class1, plot_path):
        ...
        axes[1].set_title('F1 Score for Class 1 (Abnormal)', fontsize=18, fontweight='bold')
    ...
    def _plot_confusion_matrix(self, y_true, y_pred, class_names, plot_path, setting):
        ...
        sns.heatmap(cm_proportion, annot=annot_labels, fmt='', cmap='Blues', 
                    ...
                    annot_kws={'fontsize': 16})  # 增大注释字体
            
        plt.title(f'Confusion Matrix - {setting}', fontsize=20, fontweight='bold')
        ...
        plt.figtext(0.02, 0.02, f'F1 score: {f1_class1:.4f}', fontsize=14)
